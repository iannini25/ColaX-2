...
PyObject *global_constants[111] = {0};
...
static void _createGlobalConstants(PyThreadState *tstate) {
    ...
    Nuitka_SysSetObject(
        "executable",
#if !_NUITKA_STANDALONE_MODE
        global_constants[110]
#else
        getStandaloneSysExecutablePath(global_constants[110])
#endif
    );
    ...
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 2, Nuitka_PyInt_FromLong(3));
