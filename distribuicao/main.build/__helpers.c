...
PyObject *CALL_FUNCTION_WITH_ARGS11_KW_SPLIT(PyThreadState *tstate, PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (likely(func != NULL)) {
            NUITKA_DYNAMIC_ARRAY_DECL(vectorcall_args, PyObject *, 11 + kwargs_count);

            memcpy(vectorcall_args, args, 11*sizeof(PyObject *));
            memcpy(&vectorcall_args[11], kw_values, kwargs_count*sizeof(PyObject *));
...
PyObject *CALL_FUNCTION_WITH_ARGS13_KW_SPLIT(PyThreadState *tstate, PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (likely(func != NULL)) {
            NUITKA_DYNAMIC_ARRAY_DECL(vectorcall_args, PyObject *, 13 + kwargs_count);

            memcpy(vectorcall_args, args, 13*sizeof(PyObject *));
            memcpy(&vectorcall_args[13], kw_values, kwargs_count*sizeof(PyObject *));
